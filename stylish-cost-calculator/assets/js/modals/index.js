import StylishCostCalculatorModalController from './controller';
import { sccIsBannerDismissed } from './banner-utilities';
 ...
 */
export default function createModal( { context, title, content, showBanner = false, bannerOnly = false, description, affirmativeButtonText, negativeButtonText, affirmativeButtonCallback, negativeButtonCallback, bannerMountNode } ) {
	...
	const modal = new StylishCostCalculatorModalController( {
		context,
		title,
		description,
		showBanner,
