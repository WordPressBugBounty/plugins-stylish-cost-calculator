...
<div class="modal fade" id="quote_lists_modal" tabindex="-1" aria-labelledby="settingsModalLabel" aria-hidden="true">
  <div class="modal-dialog">
	<div class="modal-content">
	  ...
	  <br><br>
	  <a class=" btn btn-settings-bar buynow-btn" style="color: #000; padding:20px;" target="_blank" href="https://www.stylishcostcalculator.com?utm_source=scc-free-plugin&utm_medium=wordpress&utm_campaign=free_to_premium&utm_content=premium-feature-lock">Buy Now</a>
