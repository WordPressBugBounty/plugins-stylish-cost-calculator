        ...
        foreach ( $forms as $f ) {
			...
			<div id="scc_calculator_<?php echo intval( $f->id ); ?>" class="col-md-6 p-0">
				<div style="text-align: center;background-color:#fff; margin-bottom:30px; margin-right:30px; padding:30px;border-radius:10px">
					...
					<a class="opt-secondary" style="padding:8px 25px;color:white;background:#314af3;text-decoration: none;font-weight:normal;" href="<?php echo esc_url( admin_url( 'admin.php?page=scc_edit_items' ) . '&id_form=' . intval( $f->id ) ); ?>">Edit</a>
