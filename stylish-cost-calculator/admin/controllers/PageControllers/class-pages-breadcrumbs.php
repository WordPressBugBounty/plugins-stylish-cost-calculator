...
class PagesBreadcrumbs {
    ...
    public function __construct() {
        ...
        if ( is_admin() ) {
            ...
            wp_register_script( 'scc-settings-modal-react', SCC_URL . 'dist/backend/scc-settings-modal-react.js', [ 'wp-element' ], scc_get_file_version( SCC_DIR . '/dist/backend/scc-settings-modal-react.js' ), true );
